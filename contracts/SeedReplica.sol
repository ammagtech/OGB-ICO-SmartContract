...
contract SeedReplica is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ///////////////////// Variables ///////////////////////
    ...
    function initialize(address _OGBAddress, address _launchContract) public initializer {
        __Ownable_init();
        __UUPSUpgradeable_init();
        OGBAddress = _OGBAddress;
        launchContract = _launchContract;
        USDT_To_OGB_Rate = 18 * 10**15; //0.018 USDT to 1 $OGB 18*10**-12;
        tokenGenPercentage = 525 * 10**16; // 5.25%
        devFee = 1* 10**16; //1%
    ...
    function depositPrePaid() public onlyOwner{
        ...
        for(uint256 x=0; x < _clientDetailarr.length; x++){
            ...
            require(_clientDetailarr[x]._USDTamount > 0, "Amount must be greater than zero");
            require(collectedUsdt+_clientDetailarr[x]._USDTamount <= usdtLimit, "OUt of depth error" );
            collectedUsdt += _clientDetailarr[x]._USDTamount;
            uint256 accurateOGBToken = getAccurateRate(_clientDetailarr[x]._USDTamount);
            bookedTokens += accurateOGBToken;
            USDTDeposites[_clientDetailarr[x].clientAddress] += _clientDetailarr[x]._USDTamount;
            uint256 accurateBeforeVestingT = getBeforeVestingToken(accurateOGBToken);
            beforeVestingTokens[_clientDetailarr[x].clientAddress] += accurateBeforeVestingT;
            OGBDelivered[_clientDetailarr[x].clientAddress] += accurateOGBToken - accurateBeforeVestingT;
        }
    }
    

    function getAccurateRate(uint256 _USDTAmount) private view returns(uint256 _result) {
        
        uint256 OGBToken = ((_USDTAmount.mul(10**18)).div(USDT_To_OGB_Rate));
        ...
        if(step3 >4){
            //if(((_amount.mul(10**18)).div(USDT_To_OGB_Rate)) % 2 == 1){
                _result = (((_USDTAmount.mul(10**2).add(1)).mul(10**18)).div(USDT_To_OGB_Rate))/10**2;    
            //}
        }
        else{
            _result = ((_USDTAmount.mul(10**18)).div(USDT_To_OGB_Rate));
        }
    }
    function getBeforeVestingToken(uint256 OGBToken) private view returns(uint256 _result) {
    ...
    function release(address _benifierAddress) public {
        require(_benifierAddress == msg.sender, "caller must be benifier address");
        require(USDTDeposites[_benifierAddress] > 0, "You do not have OGBs to withdraw");
    ...
    function getClientRecord() private {

        _clientDetail.push(ClientDetail(0xA24fB11bd39Ddb820d9a072c1e4204213013d258, 4100 * 10**18));
        _clientDetail.push(ClientDetail(0xCa015d649De597AcAC06740239b7d25234478428, 500 * 10**18));
        _clientDetail.push(ClientDetail(0xd826deEe4Eeb0C5Fc728c76164cf65e900ab2Ab6, 4000 * 10**18));
        _clientDetail.push(ClientDetail(0x9d3d65089A03C43e0e536181A5a86a4D79aed2F9, 1000 * 10**18));
        _clientDetail.push(ClientDetail(0x2B4A8FbFCf7bFe6038f01e11f788D26D6e35d4aB, 5000 * 10**18));
        _clientDetail.push(ClientDetail(0x1cE5F81e46dA42Ad8c3dE486c4a44A8423C44326, 66987 * 10**17));
        _clientDetail.push(ClientDetail(0x6A62f1e5f29B3F290bA4756dD691bfB71b7Fc6c4, 5000 * 10**18));
        _clientDetail.push(ClientDetail(0xc94cc891554c9adc46fd5FD4515A95832AAdC8D6, 1600 * 10**18));
        _clientDetail.push(ClientDetail(0x4C5F8F1c8dbcCc6E314C4B12DA26A3B6c7522Cdc, 700 * 10**18));
        _clientDetail.push(ClientDetail(0xB05214F2f46a267ABbf47EA42f5bEA8cE413ab55, 5000 * 10**18));
        _clientDetail.push(ClientDetail(0xA18Ec00c51467Dd69FABBEAa1AD3264c5b9b9919, 1000 * 10**18));
        _clientDetail.push(ClientDetail(0x21C89BF352aDaED97349Fdfd74f00fA2F897Ce83, 1000 * 10**18));
        _clientDetail.push(ClientDetail(0xB5D27fBCCAc538c7CacDF61209812F8F482487Df, 1000 * 10**18));
        _clientDetail.push(ClientDetail(0x9706870afc46E15414e9FD0704ec35039D358D97, 1000 * 10**18));
        _clientDetail.push(ClientDetail(0x7b98e496E68828ed4D35FacaE495B90D387561EE, 2000 * 10**18));
        _clientDetail.push(ClientDetail(0xf737Ee6a8DccA7CB3205185B911CF2ae1748Ec5e, 10000 * 10**18));
        _clientDetail.push(ClientDetail(0xFB99DE1D7B00546edf18EC0e547e47694a1246F6, 1000 * 10**18));
        _clientDetail.push(ClientDetail(0x3AD14ee7990E5118C9003665686c3917B76eC1Da, 1000 * 10**18));
        _clientDetail.push(ClientDetail(0xAe2452E443b523a57F135DB9c1BA41342482a33C, 1000 * 10**18));
        _clientDetail.push(ClientDetail(0xbc186EF62F2e14FFc9c9c843e40e2a7ad34C7aD1, 800 * 10**18));
        _clientDetail.push(ClientDetail(0xe77EaDB02796663d8B32A9Ee3bA8A1b403ee79Bb, 1000 * 10**18));
        _clientDetail.push(ClientDetail(0x1CC1ABE4744Dd5Dd7066ab9C6F2E3B49C39F9A54, 1400 * 10**18));
        _clientDetail.push(ClientDetail(0x902cB6608dBC45b19B51b657082021A6C2E30b0B, 500 * 10**18));
        _clientDetail.push(ClientDetail(0x58CDE1e4Ac6c93eD9a73Ba28e0fA3c53eC770D8f, 5000 * 10**18));
        _clientDetail.push(ClientDetail(0x5391CAd6E3334E92a476f9d60fa7569F8D13186d, 10000 * 10**18));
        _clientDetail.push(ClientDetail(0xb9e134510877a2da9C54443404F630532655B0f5, 200 * 10**18));
        _clientDetail.push(ClientDetail(0xE577cb3e1e070Dd9CBad09271d7D9B27e38C58f4, 10000 * 10**18));
        _clientDetail.push(ClientDetail(0x08678d827b39B49c5269b736b0E46527d12b6EDD, 4860 * 10**18));
        _clientDetail.push(ClientDetail(0x6f9bd00b2546a8F80De55Af780D81A26465334DE, 10000 * 10**18));
        _clientDetail.push(ClientDetail(0xFc707d2D870d7b0EBcFbfE1201350f062b7280e1, 10000 * 10**18));
        
    }

    function showClientData() public view returns(ClientDetail[] memory _data){
        _data = _clientDetail;
    }
