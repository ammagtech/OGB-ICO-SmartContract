...
contract INV_Round1 is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ///////////////////// Variables ///////////////////////
    ...
    function deposit(uint256 _amount) public {
        ...
        uint256 accurateOGBToken = getAccurateRate(_amount);
        ...
        uint256 accurateBeforeVestingT = getAccurateBeforeVestingToken(accurateOGBToken);
    ...
    function getAccurateRate(uint256 _amount) private view returns(uint256 _result) {
    ...
    function getAccurateBeforeVestingToken(uint256 OGBToken) private view returns(uint256 _result) {
