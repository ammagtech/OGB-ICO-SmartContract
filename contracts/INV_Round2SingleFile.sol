...
contract INV_Round2 is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ///////////////////// Variables ///////////////////////
    ...
    modifier onlyAdmin() {
        require(launchContract == msg.sender, "you are not authorized");
        _;
    }
