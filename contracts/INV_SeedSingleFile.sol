...
contract INV_Seed is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address _USDTAddress, address _OGBAddress, address _launchContract) public initializer {
        ...
        devFee = 1* 10**16; //1%
        //devFee = 1* 10**4; //1%
        OwnerWallet = 0x299a61AA440aA00c49D0bEfCeAD028ae3658964a;
        devWallet = 0x4A5B1C518e04aBd793EE9aac08d91ADBa61894E8;
    ...
    function deposit(uint256 _amount) public {
        ...
        ERC20(USDTAddress).transferFrom(msg.sender, devWallet, (_devAmount)/10**12);
        ERC20(USDTAddress).transferFrom(msg.sender, OwnerWallet, (_remaingAmount)/10**12);
        USDTDeposites[msg.sender] += ((_amount)/(10**12));
    ...
    function depositPrePaid() public onlyOwner{
        ...
        for(uint256 x=0; x < _clientDetailarr.length; x++){
            ...
            uint256 accurateOGBToken = getAccurateResult(_clientDetailarr[x]._USDTamount);
            bookedTokens += accurateOGBToken;
    ...
    function setLaunchAddress(address _launchAddress) public onlyOwner{
        launchContract = _launchAddress;
    }
    ...
    function release(address _benifierAddress) public {
        ...
        require((USDTDeposites[_benifierAddress]*10**12) > 0, "plz deposit some usdt first");
